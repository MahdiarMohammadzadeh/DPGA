function [] = skeletonViewer(skeleton, image, nSkeleton, axisName )
imshow(image,'parent',axisName);
 ...
 for i = 1:19
     ...
     if nSkeleton > 0
         ...
         line(X1,Y1,'Parent',axisName, 'LineWidth', 1.5, 'LineStyle', '-', 'Marker', '+', 'Color', 'r');
     end
     if nSkeleton > 1
         ...
         line(X2,Y2,'Parent',axisName, 'LineWidth', 1.5, 'LineStyle', '-', 'Marker', '+', 'Color', 'g');
     end
    hold on;
 end
 hold off;
