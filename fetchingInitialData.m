function [ trackedPositionOutput , jointCoordinates, trackedLeftHandPosition , trackedRightHandPosition , directionOfBody , height ] = fetchingInitialData(colorVid ,depthVid ,imageAxisName , bodyPosture)
preview(depthVid);
while 1
    %      Getting Data
    pause(0.5);
